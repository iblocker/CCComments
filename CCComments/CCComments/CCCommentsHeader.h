...
// 等比例适配系数
#define kScaleFit (BR_IS_IPHONE ? ((CGRectGetWidth(UIScreen.mainScreen.bounds) < CGRectGetHeight(UIScreen.mainScreen.bounds)) ? CGRectGetWidth(UIScreen.mainScreen.bounds) / 375.0f : CGRectGetWidth(UIScreen.mainScreen.bounds) / 667.0f) : 1.1f)
